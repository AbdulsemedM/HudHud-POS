...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    primaryColor: const Color(0xFF5b3895),
    ...
    navigationRailTheme: NavigationRailThemeData(
        selectedIconTheme:
            IconThemeData(color: Color(0xFF5b3895), opacity: 1, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: TextStyle(color: Color(0xFF5b3895)),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: Color(0xFF5b3895)),
      ),
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
        backgroundColor: Color(0xFF5b3895),
        splashColor: Colors.white.withAlpha(100),
        highlightElevation: 8,
        elevation: 4,
        focusColor: Color(0xFF5b3895),
        hoverColor: Color(0xFF5b3895),
    ...
    tabBarTheme: TabBarThemeData(
      ...
      labelColor: Color(0xFF5b3895),
      indicatorSize: TabBarIndicatorSize.label,
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: Color(0xFF5b3895), width: 2.0),
      ),
    ),
    sliderTheme: SliderThemeData(
      activeTrackColor: Color(0xFF5b3895),
      inactiveTrackColor: Color(0xFF5b3895).withAlpha(140),
      trackShape: RoundedRectSliderTrackShape(),
      trackHeight: 4.0,
      thumbColor: Color(0xFF5b3895),
    ...
    colorScheme: ColorScheme.light(
            primary: Color(0xFF5b3895),
            onPrimary: Colors.white,
            secondary: Color(0xff495057),
            onSecondary: Colors.white,
            surface: Color(0xffe2e7f1),
            onSurface: Color(0xff495057))
        .copyWith(secondary: Color(0xFF5b3895))
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      sliderTheme: SliderThemeData(
        activeTrackColor: Color(0xFF5b3895),
        inactiveTrackColor: Color(0xFF5b3895).withAlpha(100),
        trackShape: RoundedRectSliderTrackShape(),
        trackHeight: 4.0,
        thumbColor: Color(0xFF5b3895),
        thumbShape: RoundSliderThumbShape(enabledThumbRadius: 10.0),

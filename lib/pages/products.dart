...
class _ProductsState extends State<Products> {
  ...
  List<DropdownMenuItem<int>> _categoryMenuItems = [], _subCategoryMenuItems = [], _brandsMenuItems = [];
  ...
  findSellingPriceGroupId(locId) {
    if (usePriceGroup) {
      locationListMap.forEach((element) {
        ...
        } else if (element['id'] == selectedLocationId && element['selling_price_group_id'] == null) {
          sellingPriceGroupId = 0;
        }
      });
    } else {
  ...
  Future<String> getCartItemCount({isCompleted, sellId}) async {
    var counts = await Sell().cartItemCount(isCompleted: isCompleted, sellId: sellId);
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
                  ...
                  onPressed: () {
                    if (argument != null) {
                      Navigator.pushReplacementNamed(context, '/cart',
                          arguments: Helper().argument(locId: argument!['locationId'], sellId: argument!['sellId']));
                    } else {
                      if (selectedLocationId != 0 && cartCount > 0) {
                        Navigator.pushNamed(context, '/cart', arguments: Helper().argument(locId: selectedLocationId));
                      }

                      if (cartCount == 0) {
                        Fluttertoast.showToast(msg: AppLocalizations.of(context).translate('no_items_added_to_cart'));
                      }
                    }
                  }),
            )
        ...
        bottomNavigationBar: Visibility(visible: argument == null, child: posBottomBar('products', context)),
      ),
    );
  }
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              ...
                              offset: (byAlphabets != null) ? Offset(3, 3) : Offset(0, 0),
                            )
                          ],
                          // : null,
                        ),
                        ...
                        child: Row(
                          children: [
                            Text(
                              ...
                              style: AppTheme.getTextStyle(themeData.textTheme.titleMedium,
                                  fontWeight: 700,
                                  color: (byAlphabets != null) ? themeData.colorScheme.primary : Colors.grey),
                            ),
                            Icon(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              ...
                              offset: (byPrice != null) ? Offset(3, 3) : Offset(0, 0),
                            )
                          ],
                          // : null,
                        ),
                        ...
                        child: Row(
                          children: [
                            Text(
                              ...
                              style: AppTheme.getTextStyle(themeData.textTheme.titleMedium,
                                  fontWeight: 700,
                                  color: (byPrice != null) ? themeData.colorScheme.primary : Colors.grey),
                            ),
                            Icon(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: AppTheme.getTextStyle(themeData.textTheme.bodyLarge, fontWeight: 600, letterSpacing: 0),
                  ),
                ),
                Container(
                ...
                Container(
                  padding: EdgeInsets.only(left: MySize.size16!, right: MySize.size16!, top: 0),
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton(
                        isExpanded: true,
                        dropdownColor: themeData.colorScheme.background,
  ...
  getScannedProduct(String barcode) async {
    if (canMakeSell) {
      await Variations()
          .get(locationId: selectedLocationId, barcode: barcode, offset: 0, searchTerm: searchController.text)
          .then((value) async {
        if (canAddSell) {
          if (value.length > 0) {
            var price;
      ...
      child: DropdownButton(
            ...
            return DropdownMenuItem<int>(
                ...
                child: SizedBox(
                  ...
                  child: Text('${value['name']}',
                      softWrap: true, overflow: TextOverflow.ellipsis, maxLines: 2, style: TextStyle(fontSize: 15)),
                ));
          }).toList(),
          onTap: () {
          ...
          onChanged: (int? newValue) async {
            ...
            if (canChangeLocation) {
              ...
              Fluttertoast.showToast(msg: AppLocalizations.of(context).translate('cannot_change_location'));
            }
          }),
    );
  }
              ...
              Hero(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.only(
                      topLeft: Radius.circular(MySize.size8!), topRight: Radius.circular(MySize.size8!)),
                  child: CachedNetworkImage(
                      width: MediaQuery.of(context).size.width,
                      height: MySize.size140,
                      fit: BoxFit.fitHeight,
                      errorWidget: (context, url, error) => Image.asset('assets/images/default_product.png'),
                      placeholder: (context, url) => Image.asset('assets/images/default_product.png'),
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(widget.name!,
                    ...
                    style: AppTheme.getTextStyle(themeData.textTheme.titleSmall, fontWeight: 500, letterSpacing: 0)),
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        ...
                        style: AppTheme.getTextStyle(themeData.textTheme.bodyMedium, fontWeight: 700, letterSpacing: 0),
                      ),
                      Container(
                        decoration: BoxDecoration(
                            color: themeData.colorScheme.primary,
        ...
        trailing: Column(
          ...
          children: <Widget>[
            ...
            Container(
              width: MySize.size80,
              decoration: BoxDecoration(
                  color: themeData.colorScheme.primary, borderRadius: BorderRadius.all(Radius.circular(MySize.size4!))),
              padding: EdgeInsets.only(
                  left: MySize.size6!,
                  right: MySize.size8!,
                  top: MySize.size2!,

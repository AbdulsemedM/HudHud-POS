...
class _ContactsState extends State<Contacts> {
  ...
  bool isLoading = false, useOrderBy = false, orderByAsc = true, useSearchBy = false;
  ...
  void initState() {
    ...
    leadsListController.addListener(() {
      if (leadsListController.position.pixels == leadsListController.position.maxScrollExtent) {
        setLeadsList();
      }
    });
    ...
    suppliersListController.addListener(() {
      if (suppliersListController.position.pixels == suppliersListController.position.maxScrollExtent) {
        setSuppliersList();
      }
    });
    Helper().syncCallLogs();
          ...
          bottom: TabBar(
              ...
              tabs: [
                ...
                Tab(
                  ...
                  child: Text(AppLocalizations.of(context).translate('suppliers')),
                )
              ]),
        ),
        body: TabBarView(
            ...
            Row(
              ...
              children: [
                TextButton.icon(
                  ...
                  icon:
                      (useOrderBy) ? Icon(Icons.keyboard_arrow_up_outlined) : Icon(Icons.keyboard_arrow_down_outlined),
                  label: (useOrderBy)
                      ? Text(
                          "${AppLocalizations.of(context).translate('order_by')} :",
                          style:
                              AppTheme.getTextStyle(themeData.textTheme.bodyLarge, fontWeight: 600, letterSpacing: 0),
                        )
                      : Text(
                          AppLocalizations.of(context).translate('tap_for_order_by'),
                          style:
                              AppTheme.getTextStyle(themeData.textTheme.bodyLarge, fontWeight: 600, letterSpacing: 0),
                        ),
                ),
                Visibility(
                  ...
                  child: TextButton.icon(
                    ...
                    label: Text(
                      ...
                      style: AppTheme.getTextStyle(themeData.textTheme.bodyLarge, fontWeight: 500, letterSpacing: 0),
                    ),
                    icon: (orderByAsc)
                        ? Icon(
                        ...
                        : Icon(MdiIcons.arrowDownCircleOutline, color: Colors.black),
                  ),
                )
              ],
            ),
                ...
                children: [
                  ListTile(
                    title: Text(
                      ...
                      style: AppTheme.getTextStyle(themeData.textTheme.bodyMedium, fontWeight: 500, letterSpacing: 0),
                    ),
                    leading: Radio(
                      value: 'name',
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          Visibility(
            visible: (contactDetails['name'].toString() != 'null' && contactDetails['name'].toString().trim() != ''),
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(
          ...
          Visibility(
            visible: (contactDetails['upcoming_follow_up'].toString() != 'null' &&
          ...
          Row(
            ...
            children: [
              Helper().callDropdown(context, contactDetails,
                  [contactDetails['mobile'], contactDetails['alternate_number'], contactDetails['landline']],
                  type: 'call'),
              SizedBox(
                height: MySize.size40!,
                child: TextButton.icon(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => FollowUpForm(contactDetails)));
                  },
                  icon: Icon(
                    Icons.add,
                  ...
                  children: <Widget>[
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      child: TextFormField(
                                        ...
                                        validator: (value) {
                                          if (value!.length < 1) {
                                            return AppLocalizations.of(context).translate('please_enter_your_name');
                                          } else {
                                            return null;
                                          }
                                        },
                                    ...
                                    Container(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          hintStyle: themeData.textTheme.titleSmall!
                                              .merge(TextStyle(color: themeData.colorScheme.onBackground)),
                                          hintText: AppLocalizations.of(context).translate('middle_name'),
                                          border: UnderlineInputBorder(
                                            borderSide: BorderSide(
                                                color: themeData.inputDecorationTheme.border!.borderSide.color),
                                          ),
                                ...
                                children: <Widget>[
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      border: UnderlineInputBorder(
                                        borderSide:
                                            BorderSide(color: themeData.inputDecorationTheme.border!.borderSide.color),
                                      ),
                                      enabledBorder: UnderlineInputBorder(
                                        borderSide: BorderSide(
                                            color: themeData.inputDecorationTheme.enabledBorder!.borderSide.color),
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      hintStyle: themeData.textTheme.titleSmall!
                                          .merge(TextStyle(color: themeData.colorScheme.onBackground)),
                                      hintText: AppLocalizations.of(context).translate('address_line_2'),
                                      border: UnderlineInputBorder(
                                        borderSide:
                                            BorderSide(color: themeData.inputDecorationTheme.border!.borderSide.color),
                                      ),
                              ...
                              child: Column(
                                children: <Widget>[
                                  TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value!.length < 1) {
                                        return AppLocalizations.of(context).translate('please_enter_your_number');
                                      } else {
                                        return null;
                                      }
                                    },
                    ...
                    Container(
                      ...
                      child: TextButton(
                          ...
                          if (await Helper().checkConnectivity()) {
                            if (_formKey.currentState!.validate()) {
                              ...
                              await CustomerApi().add(newCustomer).then((value) {
                                if (value['data'] != null) {
                                  Contact().insertContact(Contact().contactModel(value['data'])).then((value) {
                                    Navigator.pop(context);
                        ...
                        child: Text(AppLocalizations.of(context).translate('add_to_contact').toUpperCase(),

...
class _HomeState extends State<Home> {
  var user, note = new TextEditingController(), clockInTime = DateTime.now(), selectedLanguage;
  LatLng? currentLoc;
  ...
  bool accessExpenses = false, attendancePermission = false, notPermitted = false, syncPressed = false;
  bool? checkedIn;
  ...
  checkIOButtonDisplay() async {
    ...
    if (activeSubscriptionDetails.length > 0 && activeSubscriptionDetails[0].containsKey('package_details')) {
              ...
              onPressed: () async {
                ...
                await SellDatabase().getNotSyncedSells().then((value) {
                  if (value.isEmpty) {
                    ...
                    Fluttertoast.showToast(msg: AppLocalizations.of(context).translate('sync_all_sales_before_logout'));
                  }
                });
              },
              child: Text(
            ...
            children: <Widget>[
              Card(
                child: Container(
                  ...
                  child: Text(AppLocalizations.of(context).translate('welcome') + ' $userName',
                      style:
...
//homepage drawer
                    ...
                    child: GestureDetector(
                      ...
                      child: Text(
                        ...
                        style: AppTheme.getTextStyle(themeData.textTheme.titleSmall,
                            color: themeData.colorScheme.error, fontWeight: 600),
                      ),
                    ),
                  ...
                  Visibility(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                        ...
                        style: AppTheme.getTextStyle(themeData.textTheme.titleSmall, fontWeight: 600),
                      ),
                    ),
                  ),
                  ListTile(
            ...
            Expanded(
                ...
                child: Container(
                    ...
                    child: Text(
                      ...
                      style:
                          AppTheme.getTextStyle(themeData.textTheme.bodyMedium, fontWeight: 400, letterSpacing: -0.2),
                    )))
          ],
        ),
      ),
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(subject!,
                  style: AppTheme.getTextStyle(themeData.textTheme.titleMedium, fontWeight: 600, color: Colors.white)),
              Text("$amount",
      ...
      child: Column(
        children: <Widget>[
          Text(AppLocalizations.of(context).translate('payment_details'),
              style: AppTheme.getTextStyle(themeData.textTheme.titleMedium, fontWeight: 700, letterSpacing: -0.2)),
          ListView.builder(
  ...
  getPermission() async {
    ...
    await Helper().getPermission('essentials.allow_users_for_attendance_from_api').then((value) {
      if (value == true) {
          ...
          children: <Widget>[
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: (!checkedIn!) ? themeData.colorScheme.primary : themeData.colorScheme.background,
              ),
              onPressed: () async {
                Helper().syncCallLogs();
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: Text(
                            (!checkedIn!)
                                ? AppLocalizations.of(context).translate('check_in_note')
                                : AppLocalizations.of(context).translate('check_out_note'),
                            textAlign: TextAlign.center,
              ...
              child: (!checkedIn!)
                  ? Text(AppLocalizations.of(context).translate('check_in'),
                      style: AppTheme.getTextStyle(themeData.textTheme.titleLarge,
                          color: themeData.colorScheme.background, fontWeight: 600))
                  : Text(AppLocalizations.of(context).translate('check_out'),
                      style: AppTheme.getTextStyle(themeData.textTheme.titleLarge,
                          color: themeData.colorScheme.primary, fontWeight: 600)),
            ),
            Text((!checkedIn!) ? '' : DateTime.now().difference(clockInTime).toString(),

                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      children: [
                        Text(
                          AppLocalizations.of(context).translate('Did_you_meet_with_the_contact'),
                          style: AppTheme.getTextStyle(
                    ...
                    Visibility(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(top: MySize.size4!, bottom: MySize.size10!),
                            child: TextFormField(
                              controller: reasonController,
                              validator: (value) {
                                if (visitStatus == "did_not_meet_contact" && reasonController.text.trim() == "") {
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                labelText: "${AppLocalizations.of(context).translate('mobile_no')}",
                                border: themeData.inputDecorationTheme.border,
                                enabledBorder: themeData.inputDecorationTheme.border,
                                focusedBorder: themeData.inputDecorationTheme.focusedBorder,
                              ),
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: "${AppLocalizations.of(context).translate('designation')}",
                              border: themeData.inputDecorationTheme.border,
                              enabledBorder: themeData.inputDecorationTheme.border,
                              focusedBorder: themeData.inputDecorationTheme.focusedBorder,
                            ),
                    ...
                    ListTile(
                      leading: Icon(
                        (showMeet2) ? MdiIcons.minusCircle : MdiIcons.plusCircle,
                        color: themeData.colorScheme.primary,
                      ),
                      title: Text("${AppLocalizations.of(context).translate('add_meet')} 2"),
                      onTap: () {
                        setState(() {
                          showMeet2 = !showMeet2;
                        });
                    ...
                    ListTile(
                      leading: Icon(
                        (showMeet3) ? MdiIcons.minusCircle : MdiIcons.plusCircle,
                        color: themeData.colorScheme.primary,
                      ),
                      title: Text("${AppLocalizations.of(context).translate('add_meet')} 3"),
                      onTap: () {
                        setState(() {
                          showMeet3 = !showMeet3;
                        });
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: () async {
                            ...
                            try {
                              await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high)
                                ...
                                if (currentLoc != null) {
                                  setState(() {
                                    location = "longitude: ${currentLoc!.longitude.toString()},"
                          ...
                          label: Text("${AppLocalizations.of(context).translate('get_current_location')}"),
                        ),
                      ],
                    ),
                    Row(
                          ...
                          if (await Helper().checkConnectivity()) {
                            if (visitStatus == "assigned") {
                              ...
                              Fluttertoast.showToast(
                                  msg: AppLocalizations.of(context).translate('please_enter_visit_status'));
                            }

                            if (_image == null) {
                              validated = false;
                              Fluttertoast.showToast(
                                  msg: AppLocalizations.of(context).translate('please_upload_image_of_visited_place'));
                            } else {
                            ...
                            if (currentLoc == null) {
                              validated = false;
                              Fluttertoast.showToast(
                                  msg: AppLocalizations.of(context).translate('please_add_current_location'));
                            }
                            ...
                            if (_formKey.currentState!.validate() && validated) {
                              ...
                              Map visitDetails = {
                                ...
                                if (visitStatus == "did_not_meet_contact")
                                  'reason_to_not_meet_contact': reasonController.text,
                                'visited_on': DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.now()),
                              ...
                              FieldForceApi().update(visitDetails, widget.visit['id']).then((value) {
                                if (value != null) {
                                  Fluttertoast.showToast(msg: AppLocalizations.of(context).translate('status_updated'));
                                }
...
class _FollowUpFormState extends State<FollowUpForm> {
  ...
  String selectedStatus = 'completed', selectedFollowUpType = 'call', duration = '';
  Map<String, dynamic> selectedFollowUpCategory = {'id': 0, 'name': 'Please select'};
    ...
    if (widget.edit == true) {
      ...
      followUpCategory.forEach((element) {
        if (widget.customerDetails['followup_category'] != null &&
            element['id'] == widget.customerDetails['followup_category']['id']) {
          setState(() {
  ...
  getFollowUpCategories() async {
    await FollowUpApi().getFollowUpCategories().then((value) async {
      value.forEach((element) {
        followUpCategory.add({'id': int.parse(element['id'].toString()), 'name': element['name']});
        setState(() {});
      });
                  ...
                  children: [
                                ...
                                child: DropdownButtonFormField(
                                  ...
                                  onChanged: (newValue) {
                                    setState(() {
                                      ...
                                      if ((newValue.toString().toLowerCase() == 'call' &&
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: DropdownButtonFormField(
                              value: (followUpCategory.contains(selectedFollowUpCategory))
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        readOnly: true,
                        decoration: InputDecoration(
                          labelText: AppLocalizations.of(context).translate('start_datetime'),
                        ...
                        onTap: () {
                          DatePicker.showDateTimePicker(
                            ...
                            minTime: DateTime.now().subtract(Duration(days: 366)),
                            maxTime: DateTime.now().add(Duration(days: 180)),
                            onConfirm: (date) {
                              setState(() {
                                startDateController.text =
                                    '${date.year}-${date.month.toString().padLeft(2, '0')}-${date.day.toString().padLeft(2, '0')} '
                                    '${date.hour > 12 ? (date.hour - 12).toString().padLeft(2, '0') : date.hour.toString().padLeft(2, '0')}:${date.minute.toString().padLeft(2, '0')} '
                                    '${date.hour >= 12 ? 'PM' : 'AM'}';
                              });
                            },
                    ...
                    // DateTimePicker(controller: startDateController, type: DateTimePickerType.dateTime, firstDate: DateTime.now().subtract(Duration(days: 366)), lastDate: DateTime.now().add(Duration(days: 180)), dateMask: 'yyyy-MM-dd    hh:mm a', dateLabelText: "${AppLocalizations.of(context).translate('start_datetime')}:", style: AppTheme.getTextStyle(themeData.textTheme.bodyText1, fontWeight: 500, color: themeData.colorScheme.onBackground,), onChanged: (val) {setState(() {startDateController.text = val;});}, validator: (value) {if (value == '') return "${AppLocalizations.of(context).translate('start_datetime')} ""${AppLocalizations.of(context).translate('required')}"; else return null;},),
                    Padding(
                      padding: EdgeInsets.only(top: MySize.size16!),
                      child: TextField(
                        ...
                        readOnly: true,
                        decoration: InputDecoration(
                          labelText: AppLocalizations.of(context).translate('end_datetime'),
                          border: OutlineInputBorder(),
                        ),
                        onTap: () {
                          DatePicker.showDateTimePicker(
                      ...
                      // DateTimePicker(controller: endDateController, type: DateTimePickerType.dateTime, firstDate: DateTime.now().subtract(Duration(days: 366)), lastDate: DateTime.now().add(Duration(days: 180)), dateMask: 'yyyy-MM-dd    hh:mm a', dateLabelText: "${AppLocalizations.of(context).translate('end_datetime')}:", style: AppTheme.getTextStyle(themeData.textTheme.bodyText1, fontWeight: 500, color: themeData.colorScheme.onBackground,), onChanged: (val) {setState(() {endDateController.text = val;});}, validator: (value) {if (value == '') return "${AppLocalizations.of(context).translate('end_datetime')} ""${AppLocalizations.of(context).translate('required')}"; else return null;},),
                    ),
                    Padding(
                      padding: EdgeInsets.only(top: MySize.size16!),
                      child: TextFormField(
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            //form validation
                            if (selectedFollowUpType == 'call' && selectedStatus == 'completed') {
                              onSubmit();
  ...
  onSubmit() async {
    if (_formKey.currentState!.validate() && showError == false) {
      ...
      int response = (widget.edit == true)
          ? await FollowUpApi().update(followUp, widget.customerDetails['followUpId'])

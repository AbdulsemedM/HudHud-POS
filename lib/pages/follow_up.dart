...
class _FollowUpState extends State<FollowUp> {
  ...
  List<String> followUpStatusList = ["All", "Scheduled", "Open", "Canceled", "Completed"],
  ...
  void initState() {
    ...
    followUpListController.addListener(() {
      if (followUpListController.position.pixels == followUpListController.position.maxScrollExtent) {
        getFollowUpList();
      }
    });
    Helper().syncCallLogs();
                                ...
                                children: [
                                  Visibility(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Visibility(
                                          visible: (followUpList[index]['customer']['name'] != null &&
                                              followUpList[index]['customer']['name'].toString().trim() != ''),
                                          child: Text(
                                        ...
                                        Visibility(
                                          visible: (followUpList[index]['customer']['supplier_business_name'] != null &&
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              (followUpList[index]['customer']['address_line_1'] != null)
                                                  ? Text(
                                                  ...
                                                  : Container(),
                                              (followUpList[index]['customer']['address_line_2'] != null)
                                                  ? Text(
                                              ...
                                              (followUpList[index]['customer']['email'] != null)
                                                  ? Text(
                                                  ...
                                                  : Container(),
                                              (followUpList[index]['customer']['mobile'] != null)
                                                  ? Text(
  ...
  Widget contactBlock(followUpDetails) {
    return Container(
      child: Column(
        ...
        children: [
          Visibility(
            visible: (followUpDetails['customer']['supplier_business_name'] != null &&
                followUpDetails['customer']['supplier_business_name'].toString().trim() != ''),
            child: Text(
            ...
            children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        (followUpDetails['status'] != null) ? '${followUpDetails['status'].toUpperCase()}' : '-',
                        overflow: TextOverflow.ellipsis,
                        style: AppTheme.getTextStyle(
                          themeData.textTheme.bodyMedium,
                          fontWeight: 500,
                  ...
                  Visibility(
                    visible: (followUpDetails['start_datetime'].toString() != 'null' &&
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          (followUpDetails['start_datetime'].toString() != 'null')
                  ...
                  Visibility(
                    visible: (followUpDetails['end_datetime'].toString() != 'null' &&
              ...
              Column(
                ...
                children: [
                  ...
                  Visibility(
                    visible: (followUpDetails['schedule_type'] == 'call' && followUpDetails['status'] == 'open'),
...
//filter widget
  ...
  getFollowUpURL(
      {String? perPage = '10', String? startDate, String? endDate, String? followUpType, String? followUpStatus}) {
    String url = Api().apiUrl + "crm/follow-ups?";

    Map<String, dynamic> params = {'order_by': 'start_datetime', 'direction': 'desc'};
    if (perPage != null) {

          ...
          child: Column(
            ...
            children: [
              CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => Image.asset('assets/images/splash_screen.png'),
              ),
              ...
              ElevatedButton.icon(
                ...
                icon: Icon(Icons.navigate_next, color: themeData.colorScheme.primary),
                ...
                style: ElevatedButton.styleFrom(
                    backgroundColor: themeData.colorScheme.onPrimary, shadowColor: themeData.colorScheme.primary),
              ),
              Visibility(

...
class _FieldForceState extends State<FieldForce> {
  ...
  String? fieldForceUrl = Api().apiUrl + "field-force?per_page=10&assigned_to=${Config.userId}";
  ...
  void initState() {
    ...
    fieldForceListController.addListener(() {
      if (fieldForceListController.position.pixels == fieldForceListController.position.maxScrollExtent) {
        getFieldForceList();
      }
    });
    Helper().syncCallLogs();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => NewVisitForm()));
          },
        ),
        appBar: AppBar(
          elevation: 0,
          ...
          title: Text(AppLocalizations.of(context).translate('field_force_visits'),
  ...
  onToggleFilter(int index) {
    ...
    if (index == 1) {
      formattedDate = DateFormat('yyyy-MM-dd').format(DateTime.now().add(Duration(days: 1)));
    }
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                GestureDetector(
                                  child: Icon(
                                    (showCustomerDetails == index) ? MdiIcons.chevronUp : MdiIcons.chevronDown,
                                    color: themeData.colorScheme.primary,
                                  ),
                                  onTap: () {
                                    setState(() {
                                      showCustomerDetails = (showCustomerDetails == index) ? null : index;
                                    });
                                  },
                                )
                              ],
                              ...
                              children: [
                                Visibility(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Visibility(
                                        visible: (fieldForceList[index]['visited_address'] == null),
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Visibility(
                                              visible: (fieldForceList[index]['contact']['name'] != null),
                                              child: Text(
                                            ...
                                            Visibility(
                                              visible:
                                                  (fieldForceList[index]['contact']['supplier_business_name'] != null),
                                              child: Text(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Visibility(
                                                        visible: fieldForceList[index]['contact']['address'] != null,
                                                        child: Text(
                                                      ...
                                                      Visibility(
                                                        visible: fieldForceList[index]['contact']['email'] != '',
                                                        child: Text(
                                                      ...
                                                      Visibility(
                                                        visible:
                                                            fieldForceList[index]['contact']['contact_numbers'].length >
                                                                0,
                                                        child: Text(
                                        ...
                                        child: Row(
                                          children: [
                                            SizedBox(
                                              width: MySize.screenWidth! * 0.75,
                                              child: Text(
                                                (fieldForceList[index]['visited_address'] != null)
                                            ...
                                            Container(
                                              child: Visibility(
                                                ...
                                                child: IconButton(
                                                  ...
                                                  onPressed: () async {
                                                    String address = (fieldForceList[index]
                                                                    ['visited_address_latitude'] !=
                                                                null &&
                                                            fieldForceList[index]['visited_address_latitude'] != null)
  ...
  //meet value
  Widget meetValue(int index, String? name, String? designation, String? mobile) {
  ...
  Widget visitBlock(visitDetails) {
    return Container(
      child: Column(
        ...
        children: [
          Visibility(
            visible: (visitDetails['contact']['supplier_business_name'] != null),
            child: Text(
            ...
            children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              (visitDetails['status'] != null) ? '${visitDetails['status'].toUpperCase()}' : '-',
                              overflow: TextOverflow.ellipsis,
                              style: AppTheme.getTextStyle(
                                themeData.textTheme.bodyMedium,
                                fontWeight: 500,
                        ...
                        Visibility(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                (visitDetails['visit_on'] != null) ? '${visitDetails['visit_on']}' : ' - ',
                                style: AppTheme.getTextStyle(
                                  themeData.textTheme.bodyMedium,
                                  fontWeight: 500,
                                  color: themeData.colorScheme.onBackground,
                        ...
                        Visibility(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                (visitDetails['visited_on'] != null) ? '${visitDetails['visited_on']}' : ' - ',
                                style: AppTheme.getTextStyle(
                                  themeData.textTheme.bodyMedium,
                                  fontWeight: 500,
                                  color: themeData.colorScheme.onBackground,
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    Visibility(
                      visible: (visitDetails['assigned_to'] == Config.userId && visitDetails['status'] == 'assigned'),
                      child: GestureDetector(
                        onTap: () async {
                          Navigator.push(
                              context, MaterialPageRoute(builder: (context) => VisitForm(visit: visitDetails)));
                        },
                        child: Icon(
                    ...
                    Visibility(
                      visible: (visitDetails['contact']['contact_numbers'].length > 0),
                      child: Helper().callDropdown(context, visitDetails, visitDetails['contact']['contact_numbers'],
                          type: 'whatsApp'),
                    ),
                    Visibility(
                      visible: (visitDetails['contact']['contact_numbers'].length > 0),
...
//filter widget
  ...
  getFieldForceURL({String? perPage = '10', String? startDate, String? endDate, String? visitStatus}) {
    String url = Api().apiUrl + "field-force?";

    Map<String, dynamic> params = {'per_page': perPage, 'assigned_to': '${Config.userId}'};
  ...
  Widget fieldVisitStatus() {
    return DropdownButtonHideUnderline(
      child: DropdownButton(
          ...
          items: fieldForceStatusList.map<DropdownMenuItem<String>>((Map<String, String> value) {
